...
// funkcja rekurencyjna HQuickSort, przyjmujaca tablice kazdego typu
template <typename T, typename Partition>
void HQuickSort(T arr[], int p, int r, Partition partition)
{
    if (p < r)
    {
        int q = partition(arr, p, r);
        HQuickSort(arr, p, q, partition);
        HQuickSort(arr, q + 1, r, partition);
    }
}
...
int main()
{
    ...
    printArray(tab2, 9);
    std::cout << std::endl;
    HQuickSort(tab2, 0, 8, hoarePartition);
    std::cout << "Po: ";
    printArray(tab2, 9);
    std::cout << std::endl;
    ...
    printArray(tab4, 5);
    std::cout << std::endl;
    HQuickSort(tab4, 0, 4, hoarePartition);
    std::cout << "Po: ";
    printArray(tab4, 5);
    std::cout << std::endl;
